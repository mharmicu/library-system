    ...
    <center>
        <div class="container">
            <div class="box">
                ...
                <p>Dear User,</p>
                <p>Please use this code to verify your account and prove that you are one of us.</p>
                <div class="divider" style="margin: 15px;"></div>
                <a style="font-weight: bold; font-size:35px;"> {{ $details['code'] }}</a>
                <div class="divider" style="margin: 15px;"></div>
                <p>If you didn't recently attempt to login with this email address, you can safely disregard this email.</p>

                <a>Yours truly,<p>{{ $details['title'] }}</p></a>
