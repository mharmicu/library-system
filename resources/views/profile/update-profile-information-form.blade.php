<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="midInit" type="text" class="mt-1 block w-full" wire:model.defer="state.midInit" autocomplete="midInit" />
            <x-jet-input-error for="midInit" class="mt-2" />
        </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="stud_num" type="text" class="mt-1 block w-full" readonly wire:model.defer="state.stud_num" autocomplete="stud_num" />
            <x-jet-input-error for="stud_num" class="mt-2" />
        </div>

        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="yrLvl" value="{{ __('Year Level') }}" />
            <x-jet-input id="yrLvl" type="text"  class="mt-1 block w-full" wire:model.defer="state.yrLvl" autocomplete="yrLvl" />
            <x-jet-input-error for="yrLvl" class="mt-2" />
        </div>
