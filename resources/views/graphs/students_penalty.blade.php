    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                        ...
                        <div class="mt-6 text-gray-500">
                            In this page, you can see the student's penalty.
                        </div>
                    </div>
        ...
        <script>
            ...
            Highcharts.chart('container1', {
                ...
                title: {
                    text: 'Student\'s penalty fee in Library S.Y. 2022-2023'
                },
                subtitle: {
                ...
                tooltip: {
                    pointFormat: 'Penalty Fee: <b>{point.y:.1f} </b>'
                },
                series: [{
                    name: 'Penalty Fee',
                    data: 
