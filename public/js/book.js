var Books = (function () {
    ...
    function init() {
        $books.each(function () {
            ...
            $parent.find("a.bk-bookback").on("click", function () {
            ...
            $bookview.on("click", function () {
                ...
                if (document.getElementById("code") != null && document.getElementById("code").value.length >= 1) {
                    var $this = $(this);
                ...
                } else if (document.getElementById("email") != null && document.getElementById("email").value != null) {
                    var $this = $(this);
